  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-10 border-b-2">
        <h1 className="text-3xl flex mx-auto justify-center text-blue-600 font-bold">Mentorship Program</h1>  
