        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-lg mb-6">
              The IT Solution Group is leading the charge in transforming businesses through cutting-edge technology solutions.
            </p>
            <input
        ...
        <div className="my-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-100 p-4 rounded-md">
              ...
              <Link href="/services/cloud-computing" className="text-blue-500">
                Learn More
              </Link>
            </div>
            ...
            <div className="bg-gray-100 p-4 rounded-md">
              ...
              <Link href="/services/web-development" className="text-blue-500">
                Learn More
              </Link>
            </div>
            ...
            <div className="bg-gray-100 p-4 rounded-md">
              ...
              <Link href="/services/cybersecurity" className="text-blue-500">
                Learn More
              </Link>
            </div>
          </div>
        ...
        <div className="my-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-100 p-4 rounded-md">
              ...
              <Link href="/services/iot-ai" className="text-blue-500">
                Learn More
              </Link>
            </div>
            ...
            <div className="bg-gray-100 p-4 rounded-md">
              ...
              <Link href="/services/tech-staffing" className="text-blue-500">
                Learn More
              </Link>
            </div>
            ...
            <div className="bg-gray-100 p-4 rounded-md">
              ...
              <Link href="/services/tech-consulting" className="text-blue-500">
                Learn More
              </Link>
            </div>
          </div>
